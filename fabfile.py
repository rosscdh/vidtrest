...
def production():
    ...
    env.remote_project_path = '/home/ubuntu/apps/vidtrest-production/'
    env.deploy_archive_path = '/home/ubuntu/apps/'
    env.virtualenv_path = '/home/ubuntu/.virtualenvs/vidtrest-production/'
    env.remote_dashboard_path = None

    env.start_service = 'supervisorctl start vidtrest-production worker-vidtrest-production:worker-vidtrest-staging_00'
    env.stop_service = 'supervisorctl stop vidtrest-production worker-vidtrest-production:worker-vidtrest-staging_00'
...
def staging():
    ...
    env.remote_project_path = '/home/ubuntu/apps/vidtrest-staging/'
    env.deploy_archive_path = '/home/ubuntu/apps/'
    env.virtualenv_path = '/home/ubuntu/.virtualenvs/vidtrest-staging/'
    env.remote_dashboard_path = None

    env.start_service = 'supervisorctl start vidtrest-staging worker-vidtrest-staging:worker-vidtrest-staging_00'
    env.stop_service = 'supervisorctl stop vidtrest-staging worker-vidtrest-staging:worker-vidtrest-staging_00'
    env.start_worker = None
    env.stop_worker = None
...
def put_confs():
    ...
    # nginx
    put(local_path='./config/environments/{environment}/vidtrest-nginx-{environment}'.format(environment=env.environment_class), remote_path='/etc/nginx/sites-enabled/', use_glob=False, use_sudo=True)
    # supervisord
    put(local_path='./config/environments/{environment}/vidtrest-{environment}.conf'.format(environment=env.environment_class), remote_path='/etc/supervisor/conf.d/', use_glob=False, use_sudo=True)
    # uwsgi
    put(local_path='./config/environments/{environment}/vidtrest-{environment}.ini'.format(environment=env.environment_class), remote_path='/etc/uwsgi/apps-enabled/', use_glob=False, use_sudo=True)


@task
def put_config():
    put(local_path='/Users/rosscdh/p/vidtrest/config'.format(environment=env.environment_class),
